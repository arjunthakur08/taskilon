"""
Django settings for taskilon project on Heroku. For more info, see:
...
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = config('GOOGLE2_KEY')
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET = config('GOOGLE2_SECRET')

SOCIAL_AUTH_GOOGLE_OAUTH_KEY = config('GOOGLE_KEY')
...
ALLOWED_HOSTS = ['taskilon.herokuapp.com', 'localhost']
